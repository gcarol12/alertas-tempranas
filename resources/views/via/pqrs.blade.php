                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('pqrs.store') }}">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-md-8">
                                <input id="name" type="text" class="form-control" name="name" placeholder="Nombre del peticionario" required>
                            </div>  
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-md-8">
                                <input id="NIT" type="text" class="form-control" name="NIT" placeholder="NIT del peticionario" required>
                            </div>  
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-md-8">
                                <input id="email" type="email" class="form-control" name="email" placeholder="E-MAIL del peticionario" required>
                            </div>  
                        </div>
