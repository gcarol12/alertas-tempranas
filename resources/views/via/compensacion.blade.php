        ...
        <div class="col-md-7">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('compensacion.store') }}">
                        @csrf
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-md-8">
                                <input id="resolucion" type="text" class="form-control" name="resolucion" placeholder="Nº resolución SENA" required>
                            </div>  
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-md-8">
                            <input  id="fecha" class="form-control"  type="text" name="fecha" placeholder="Fecha de resolución SENA" 
